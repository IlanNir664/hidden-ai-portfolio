# Module 1 Findings -- RQ1: Hidden Concentration

The S&P 500's top-10 holdings represent 43% of the index's market cap
today, versus 23% at the 2000 dot-com peak -- current concentration is
...
published top-10 weight: SPY's named AI-basket holdings sum to 34%, but a
trailing 252-day regression puts its actual return-driven exposure (beta) at
50%, and QQQ moves from a 33% naive weight to a 75%
effective one (Chart 2) -- the largest absolute gap of the portfolios tested. RSP
(equal-weight S&P) has by far the lowest direct weight (1.6%, since equal-weighting
dilutes mega-cap concentration by construction) but still shows 25% effective
...
gap (12 points), simply because 40% of it is bonds with ~zero AI
correlation. TLT itself serves as the sanity check at both ends: negligible direct
AI-basket weight and a near-zero beta (0.05).
