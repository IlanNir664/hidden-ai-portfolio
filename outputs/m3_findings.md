...
If a dot-com-style repricing occurred, QQQ's projected loss (-73%)
is the largest of the portfolios tested, versus RSP's (-53%) --
but QQQ's projected no-bubble gain (33%) is also the largest,
against RSP's (10%). SPY and the synthetic 60/40 sit between
the two: -57%/22% and
-40%/15%
...
occurred is -42%, *worse* than its -40% dot-com-style
